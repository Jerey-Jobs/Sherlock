    ...
    public static void monitorLifeCycle(Application application) {
        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                DBLog.d(activity.getComponentName().getClassName(), "onCreate");
            }

            @Override
            public void onActivityStarted(Activity activity) {
                DBLog.d(activity.getComponentName().getClassName(), "onStart");
            }

            @Override
            public void onActivityResumed(Activity activity) {
                DBLog.d(activity.getComponentName().getClassName(), "onResume");
            }

            @Override
            public void onActivityPaused(Activity activity) {
                DBLog.d(activity.getComponentName().getClassName(), "onPause");
            }

            @Override
            public void onActivityStopped(Activity activity) {
                DBLog.d(activity.getComponentName().getClassName(), "onStop");
            }

            @Override
            public void onActivitySaveInstanceState(Activity activity, Bundle outState) {
                DBLog.d(activity.getComponentName().getClassName(), "onSaveInstance");
            }

            @Override
            public void onActivityDestroyed(Activity activity) {
                DBLog.d(activity.getComponentName().getClassName(), "onDestroy");
            }
        });
    }
}